...
# Import our modules
from betting_bot import DatabaseManager, Team, Player, Game, Odds, BettingRecommendation
...
class FantasyProbabilityApp:
            ...
            for bookmaker in bookmakers:
                ...
                for market in markets:
                    ...
                    for outcome in outcomes:
                        ...
                        self.db_manager.add_odds(odds_obj)
    ...
    def _process_player_prop_data(self, prop_data: Dict, api_name: str):
        ...
        try:
            ...
            self.db_manager.add_player_prop(player_prop)
        ...
        try:
            ...
            for sport_name in sports:
                ...
                for game in games:
                    ...
                    player_props = self.db_manager.get_player_props_for_game(game.id)
